...
public class MyDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.xtext.example.mydsl.parser.antlr.internal.InternalMyDslParser parser = createParser(tokenStream);
	...
	protected org.xtext.example.mydsl.parser.antlr.internal.InternalMyDslParser createParser(XtextTokenStream stream) {
		return new org.xtext.example.mydsl.parser.antlr.internal.InternalMyDslParser(stream, getElementFactory(), getGrammarAccess());
	}
